...
class fqlManager
{
	...
	{
		$this->fqlList = array();
		$this->fqlList['GROUPS_WALL'] = "SELECT created_time, permalink, message, actor_id, message_tags, like_info, comment_info, post_id FROM stream WHERE source_id = ";
		$this->fqlList['COMMENT'] = "SELECT fromid, username, text, time, post_id, likes FROM comment WHERE post_id = ";
