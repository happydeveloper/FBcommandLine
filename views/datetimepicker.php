...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="http://eonasdan.github.io/bootstrap-datetimepicker/styles/styles.css" />
    <link rel="stylesheet" type="text/css" media="screen" href="http://eonasdan.github.io/bootstrap-datetimepicker/styles/bootstrap-datetimepicker.min.css" />
    <link rel="stylesheet" type="text/css" media="screen" href="http://eonasdan.github.io/bootstrap-datetimepicker/styles/pygments-manni.css" />
    ...
    <div class="container">
        <div class="col-md-3">
            ...
            <ul class="nav bs-sidenav">
                ...
                <li><a href="#example6">Useing without an icon</a></li>
                <li><a href="#example7">En/Disabled Dates</a></li>
                <li><a href="#example8">Using Events</a></li>
                <li><a href="#example9">Custom Icons</a></li>
                ...
                <div class="container">
                    <div class="col-md-10">
                        <div class='well'>
                            ...
                            <button class="btn btn-primary" id="setStartDate">setStartDate</button>
                            <button class="btn btn-primary" id="setEndDate">setEndDate</button>
                        ...
                        <script type="text/javascript">
                            $(function () {
                                ...
                                $("#setStartDate").click(function () {
                                    $('#datetimepicker3').data("DateTimePicker").setStartDate(moment().subtract(14, "d"));
                                });
                                $("#setEndDate").click(function () {
                                    $('#datetimepicker3').data("DateTimePicker").setEndDate(moment().add(14, "d"));
                                });
                                $("#show").click(function () {
    ...
    <span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"col-md-10"</span><span class="nt">&gt;</span>
        <span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">'well'</span><span class="nt">&gt;</span>
            <span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"form-group"</span><span class="nt">&gt;</span>
                ...
                <span class="nt">&lt;/div&gt;</span>
            <span class="nt">&lt;/div&gt;</span>
            <span class="nt">&lt;button</span> <span class="na">id=</span><span class="s">"setStartDate"</span><span class="nt">&gt;</span>setStartDate<span class="nt">&lt;/button&gt;</span>
            <span class="nt">&lt;button</span> <span class="na">id=</span><span class="s">"setEndDate"</span><span class="nt">&gt;</span>setEndDate<span class="nt">&lt;/button&gt;</span>
...
<span class="nt">&lt;/div&gt;</span>
            ...
            <div id="example5">
                ...
                <div class="callout-box callout-box-info">
                    Example 5<p>
                       Disable the time picker and use a custom date format <code>data-format="YYYY/MM/DD"</code>. (US default is <code>MM/DD/YYYY hh:mm A/PM</code>)
                    </p>
                </div>
        ...
        <span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">'well'</span><span class="nt">&gt;</span>
            <span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"form-group"</span><span class="nt">&gt;</span>
                <span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">'input-group date'</span> <span class="na">id=</span><span class="s">'datetimepicker5'</span><span class="nt">&gt;</span>
                    <span class="nt">&lt;input</span> <span class="na">type=</span><span class="s">'text'</span> <span class="na">class=</span><span class="s">"form-control"</span> <span class="na">data-format=</span><span class="s">"YYYY/MM/DD"</span> <span class="nt">/&gt;</span>
                    <span class="nt">&lt;span</span> <span class="na">class=</span><span class="s">"input-group-addon"</span><span class="nt">&gt;&lt;span</span> <span class="na">class=</span><span class="s">"glyphicon glyphicon-time"</span><span class="nt">&gt;&lt;/span&gt;</span>
                    <span class="nt">&lt;/span&gt;</span>
                <span class="nt">&lt;/div&gt;</span>
            <span class="nt">&lt;/div&gt;</span>
...
<span class="nt">&lt;/div&gt;</span>
            ...
            <div id="example7">
                <a name="example7"></a>
                <div class="callout-box callout-box-info">
                    Example 7 <p>En/Disabled Dates. Both are mutually exclusive and expect an array. Disabled dates might be used for holidays. Enabled dates might be used for available dates for a reservation.</p>
                </div>
        ...
        <span class="nt">&lt;script </span><span class="na">type=</span><span class="s">"text/javascript"</span><span class="nt">&gt;</span>
            <span class="nx">$</span><span class="p">(</span><span class="kd">function</span> <span class="p">()</span> <span class="p">{</span>
                <span class="nx">$</span><span class="p">(</span><span class="s1">'#datetimepicker7'</span><span class="p">).</span><span class="nx">datetimepicker</span><span class="p">({</span>
                    <span class="nx">defaultDate</span><span class="o">:</span> <span class="s2">"11/1/13"</span><span class="p">,</span>
...
<span class="nt">&lt;/div&gt;</span>
            ...
            <div id="example8">
                <a name="example8"></a>
                <div class="callout-box callout-box-info">
                    Example 8 <p>Events and linked pickers</p>
                </div>
                ...
                <div class="highlight highlight-html">
                    <pre>
<span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"container"</span><span class="nt">&gt;</span>
    <span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"well"</span> <span class="na">style=</span><span class="s">"height:75px;"</span><span class="nt">&gt;</span>
       <span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">'col-md-5'</span><span class="nt">&gt;</span>
            <span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"form-group"</span><span class="nt">&gt;</span>
                <span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">'input-group date'</span> <span class="na">id=</span><span class="s">'datetimepicker8'</span><span class="nt">&gt;</span>
                    <span class="nt">&lt;input</span> <span class="na">type=</span><span class="s">'text'</span> <span class="na">class=</span><span class="s">"form-control"</span> <span class="nt">/&gt;</span>
                    <span class="nt">&lt;span</span> <span class="na">class=</span><span class="s">"input-group-addon"</span><span class="nt">&gt;&lt;span</span> <span class="na">class=</span><span class="s">"glyphicon glyphicon-calendar"</span><span class="nt">&gt;&lt;/span&gt;</span>
                    <span class="nt">&lt;/span&gt;</span>
                <span class="nt">&lt;/div&gt;</span>
    ...
    <span class="nt">&lt;script </span><span class="na">type=</span><span class="s">"text/javascript"</span><span class="nt">&gt;</span>
        <span class="nx">$</span><span class="p">(</span><span class="kd">function</span> <span class="p">()</span> <span class="p">{</span>
            <span class="nx">$</span><span class="p">(</span><span class="s1">'#datetimepicker8'</span><span class="p">).</span><span class="nx">datetimepicker</span><span class="p">();</span>
            ...
            <span class="nx">$</span><span class="p">(</span><span class="s2">"#datetimepicker8"</span><span class="p">).</span><span class="nx">on</span><span class="p">(</span><span class="s2">"change.dp"</span><span class="p">,</span><span class="kd">function</span> <span class="p">(</span><span class="nx">e</span><span class="p">)</span> <span class="p">{</span>
               <span class="nx">$</span><span class="p">(</span><span class="s1">'#datetimepicker9'</span><span class="p">).</span><span class="nx">data</span><span class="p">(</span><span class="s2">"DateTimePicker"</span><span class="p">).</span><span class="nx">setStartDate</span><span class="p">(</span><span class="nx">e</span><span class="p">.</span><span class="nx">date</span><span class="p">);</span>
            <span class="p">});</span>
            <span class="nx">$</span><span class="p">(</span><span class="s2">"#datetimepicker9"</span><span class="p">).</span><span class="nx">on</span><span class="p">(</span><span class="s2">"change.dp"</span><span class="p">,</span><span class="kd">function</span> <span class="p">(</span><span class="nx">e</span><span class="p">)</span> <span class="p">{</span>
               <span class="nx">$</span><span class="p">(</span><span class="s1">'#datetimepicker8'</span><span class="p">).</span><span class="nx">data</span><span class="p">(</span><span class="s2">"DateTimePicker"</span><span class="p">).</span><span class="nx">setEndDate</span><span class="p">(</span><span class="nx">e</span><span class="p">.</span><span class="nx">date</span><span class="p">);</span>
            <span class="p">});</span>
        <span class="p">});</span>
    <span class="nt">&lt;/script&gt;</span>
<span class="nt">&lt;/div&gt;</span>
            ...
            <div id="example9">
                <a name="example9"></a>
                <div class="callout-box callout-box-info">
                    Example 9 <p>Custom Icons (e.g. Font Awesome)</p>
                </div>
                    ...
                    <div class="well">
                        <div class="form-group">
                            <div class='input-group date' id='datetimepicker10'>
                                <input type='text' class="form-control" />
                                <span class="input-group-addon"><span data-icon-element="" class="fa fa-calendar"></span>
                                </span>
                            </div>
                        </div>
                    </div>
...
<pre>
<span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"container"</span><span class="nt">&gt;</span>
    <span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"well"</span> <span class="na">style=</span><span class="s">"height:130px;"</span><span class="nt">&gt;</span>
        <span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"form-group"</span><span class="nt">&gt;</span>
            <span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">'input-group date'</span> <span class="na">id=</span><span class="s">'datetimepicker10'</span><span class="nt">&gt;</span>
                <span class="nt">&lt;input</span> <span class="na">type=</span><span class="s">'text'</span> <span class="na">class=</span><span class="s">"form-control"</span> <span class="nt">/&gt;</span>
                <span class="nt">&lt;span</span> <span class="na">class=</span><span class="s">"input-group-addon"</span><span class="nt">&gt;&lt;span</span> <span class="na">data-icon-element=</span><span class="s">""</span> <span class="na">class=</span><span class="s">"fa fa-calendar"</span><span class="nt">&gt;</span>
                      <span class="nt">&lt;/span&gt;</span>
                <span class="nt">&lt;/span&gt;</span>
            <span class="nt">&lt;/div&gt;</span>
        <span class="nt">&lt;/div&gt;</span>
...
<span class="nx">$</span><span class="p">.</span><span class="nx">fn</span><span class="p">.</span><span class="nx">datetimepicker</span><span class="p">.</span><span class="nx">defaults</span> <span class="o">=</span> <span class="p">{</span>
    ...
    <span class="nx">startDate</span><span class="o">:</span><span class="s1">1/1/1970</span><span class="p">,</span>             <span class="c1">//set a minimum date</span>
    <span class="nx">endDate</span><span class="o">:</span> <span class="1">(today +50 years)</span><span class="p">,</span>     <span class="c1">//set a maximum date</span>
    ...
    <span class="nx">enabledDates</span><span class="o">:</span><span class="s1">1/1/1970</span><span class="p">,</span>         <span class="c1">//an array of dates that <strong>can</strong> be selected</span>
    <span class="nx">icons</span> <span class="o">=</span> <span class="p">{</span>
            ...
            <div id="events">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">change.dp</h3>
                    </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">show.dp</h3>
                    </div>
                    <div class="panel-body">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">hide.dp</h3>
                    </div>
                    <div class="panel-body">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">error.dp</h3>
                    </div>
                    <div class="panel-body">
